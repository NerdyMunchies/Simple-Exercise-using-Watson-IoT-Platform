...
## Pre-requisite
An IBM Cloud account - A lite account, which is a free of charge account that doesn’t expire, can be created through going to [IBM Cloud](https://ibm.biz/IoTatAUD).
...
![1](https://user-images.githubusercontent.com/10744356/37024275-ca25d2e6-2141-11e8-88d6-d84705a2eb65.png)
...
![2](https://user-images.githubusercontent.com/10744356/37024274-c9fac27c-2141-11e8-990d-c13e91c365f5.png)
...
![3](https://user-images.githubusercontent.com/10744356/37024271-c9cbf21c-2141-11e8-80da-5d2580fbcaaf.png)

![4](https://user-images.githubusercontent.com/10744356/37024270-c9914626-2141-11e8-8b6e-1b27513c8376.png)
...
![5](https://user-images.githubusercontent.com/10744356/37024429-46ae3fb0-2142-11e8-96d0-9728395a40c9.png)
...
![6](https://user-images.githubusercontent.com/10744356/37024874-848eb192-2143-11e8-9303-c2386bd6d5dd.png)
...
![8](https://user-images.githubusercontent.com/10744356/37024956-cfb57944-2143-11e8-97f4-4faa0b26ccf8.png)
...
![7](https://user-images.githubusercontent.com/10744356/37024870-84543e86-2143-11e8-8b45-fde510bdfd75.png)
...
![9](https://user-images.githubusercontent.com/10744356/37025225-94b643e0-2144-11e8-833f-3ac18b66a535.png)
...
![10](https://user-images.githubusercontent.com/10744356/37025224-945f7dd0-2144-11e8-9255-1b3b1c36fbd9.png)
...
![11](https://user-images.githubusercontent.com/10744356/37025223-942ae8c2-2144-11e8-85d0-387b1bdde052.png)

Make sure to hit **Deploy** to see the changes. Moreover, don't forget to run the python script placed on the Raspberry Pi.

Now that all the operational nodes are done, it is time to create and customize the dashboard, which provides the User Interface (UI) part of the application. On the right hand-side of the page, click on the dashboard tab. We will notice that there are 3 tabs, each used to change the look and feel of the UI (**layout**, **Theme** & **Site**).
...
![12](https://user-images.githubusercontent.com/10744356/37025337-e594601c-2144-11e8-8a18-c3b2148e98d5.png)

The dashboard UI should look something similar to the image below, which can be reached by going to the **dashboard** tab and clicking on the *window expand looking* icon.

![13](https://user-images.githubusercontent.com/10744356/37025432-2d1fb832-2145-11e8-9e96-93308cb06618.png)
